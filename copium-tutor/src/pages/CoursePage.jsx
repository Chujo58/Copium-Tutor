    ...
    const fetchQuizzes = useCallback(async () => {
        ...
        try {
            const res = await fetch(
                `${API_URL}/projects/${projectid}/quizzes`,
                {
                    credentials: "include",
                    method: "GET",
                },
        ...
        <div className="flex">
            <Sidebar
                projectPopupStatus={{
                    ...
                    onEdited: async () => {
                        // Refresh course and projects when an edit occurs
                        try {
                            await fetchProjectsAndCourse();
                        } catch (err) {
                            console.error("Failed to refresh course after edit:", err);
                        }
                    },
                }}
                    ...
                    <div className="p-8 md:p-10">
                        ...
                        <div className="mt-8">
                            <div className="mx-auto max-w-3xl">
                                <div className="text-center text-lg font-semibold text-dark font-card">
                                ...
                                <div className="mt-2 text-center text-xs opacity-60 font-card">
                                    Tip: paste the problem statement + what you
                                                ...
                                                {quizzes
                                                    ...
                                                    .map((q) => (
                                                        <Link
                                                            ...
                                                            className="rounded-2xl border border-black/10 bg-white/40 p-4 hover:bg-white/55 transition"
                                                        >
                                                            <div className="font-semibold text-dark truncate font-card">
                                                                {q.title}
                                                            </div>
                                                            <div className="text-xs opacity-60 mt-1 truncate">
                                                                {QUIZ_TYPE_LABELS[
                                ...
                                <div className="rounded-3xl border border-black/10 bg-white/45 shadow-sm p-6">
                                    ...
                                    {indexResult ? (
                                        <div className="mt-2 text-xs opacity-70">
                                            ✅ uploaded:{" "}
                                            {indexResult.uploaded_documents ||
                                                0}
                                            , split:{" "}
