        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mt-10">
              ...
              <div className="opacity-70">
                Upload PDFs/docs here. Index them once, then generate flashcards instantly.
              </div>
              ...
              <div className="mt-4">
                <div className="flex items-center gap-3">
                  ...
                  >
                    {alreadyIndexed ? "Indexed ✓" : indexing ? "Indexing…" : "Index documents"}
                  </button>
                ...
                {indexResult ? (
                  <div className="mt-2 text-sm opacity-80">
                    ✅ Index result — uploaded: {indexResult.uploaded_documents || 0}, split
                    parts: {indexResult.uploaded_split_documents || 0}
                    {typeof indexResult.skipped_files === "number"
            ...
            <div className="mt-10">
              ...
              <div className="opacity-70">
                Tip: index documents first, then create decks for specific prompts.
              </div>
